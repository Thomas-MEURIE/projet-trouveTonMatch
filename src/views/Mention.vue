<template>
  ...
  <p class="text-center text-3xl mb-[30px]">Mentions légales</p>
  <p class="">Merci de lire avec attention les différentes modalités d’utilisation du présent site avant d’y parcourir ses pages. En vous connectant sur ce site, vous acceptez, sans réserves, les présentes modalités.<br>
<br>
Aussi, conformément à l’article n°6 de la Loi n°2004-575 du 21 Juin 2004 pour la confiance dans l’économie numérique, les responsables du présent site internet sportgetherapp.tommeurie.fr sont :<br>
<br>
Numéro de SIRET : 75221735600027<br>
<br>
Responsable éditorial : Valentin THOLOMIER <br>
<br>
12 Rue du Huit Mai 1945, 60350 ATTICHY<br>
<br>
Téléphone : 09 72 21 25 07<br>
<br>
Email : contact@espifesti.fr<br>
<br>
Site Web :  sportgetherapp.tommeurie.fr<br>
<br>
Hébergeur : OVH<br>
12 Rue du Huit Mai 1945, 60350 ATTICHY<br>
<br>
...
<br>
Ce site ( sportgetherapp.tommeurie.fr) est proposé en différents langages web (HTML, HTML5, Javascript, CSS, etc…) pour un meilleur confort d’utilisation et un graphisme plus agréable.<br>
<br>
...
<br>
Cookies : Le site sportgetherapp.tommeurie.fr peut-être amené à vous demander l’acceptation des cookies pour des besoins de statistiques et d’affichage. Un cookie est une information déposée sur votre disque dur par le serveur du site que vous visitez.<br>
<br>
...
Services fournis :<br>
<br>
L’ensemble des activités de la société ainsi que ses informations sont présentés sur notre site www.anthedesign.fr.<br>
<br>
SARL ANTHEDESIGN s’efforce de fournir sur le site www.anthedesign.fr des informations aussi précises que possible. Les renseignements figurant sur le site sportgetherapp.tommeurie.fr ne sont pas exhaustifs et les photos non contractuelles.<br>
<br>
Ils sont donnés sous réserve de modifications ayant été apportées depuis leur mise en ligne. Par ailleurs, tous les informations indiquées sur le site www.anthedesign.fr sont données à titre indicatif, et sont susceptibles de changer ou d’évoluer sans préavis.<br>
<br>
...
<br>
De manière générale, vous n’êtes pas tenu de nous communiquer vos données personnelles lorsque vous visitez notre site Internet www.espifesti.fr.<br>
<br>
